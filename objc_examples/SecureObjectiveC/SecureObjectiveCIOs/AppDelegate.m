...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
  ...
  [IPCCall ipcCall];
  [[BackgroundStuff new] backgroundStuff];
  [[KeyChainStuff new ] keychainStuff];
...
- (void)pasteBoardAccess{
  [UIPasteboard generalPasteboard];
  [UIPasteboard pasteboardWithName:@"pasteboard" create:YES];
